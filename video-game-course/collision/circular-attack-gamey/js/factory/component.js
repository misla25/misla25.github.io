(function(opspark, createjs, draw, _) {
  ...
  const RIGHT = 'RIGHT';
  const LEFT = 'LEFT';
//BACKGROU8BD IMAGE https://i.pinimg.com/736x/4e/71/b4/4e71b452dba957ccf6dead3e6bc7f925.jpg
  // BUTTON //
  _.set(opspark, 'factory.component.button',
    function(text, colorUp = 'pink', colorOver = '#ADD8E6', scaleWidthToParent = false) {
      const
