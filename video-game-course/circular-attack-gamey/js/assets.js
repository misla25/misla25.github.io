(function(window, opspark, _, createjs) {
  const
    ...
    function(canvas, fx, level) {
      ...
      return {
        ...
        makeShip(color) {
         ...
         // const ship = createjs.Bitmap("https://pbs.twimg.com/media/GNk4CA4WIAEhKjc?format=png&name=small");
          const
            radius = 25;
...
}(window, window.opspark, window._, window.createjs));
